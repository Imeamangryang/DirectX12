...
Sky::Sky(Graphics* renderer) :
	...
	m_orbitCycle(5760)
{
	LoadHeightMap(renderer, L"TychoSkymapII.t5_16384x08192.tif", L"lroc_color_poles_4k.tif");
...
void Sky::Draw3D(ID3D12GraphicsCommandList* m_commandList, XMFLOAT4X4 viewproj, XMFLOAT4 eye)
{
